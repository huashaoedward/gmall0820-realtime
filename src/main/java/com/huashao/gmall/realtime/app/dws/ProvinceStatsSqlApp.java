...
import com.huashao.gmall.realtime.bean.ProvinceStats;
 ...
 * Author: huashao
 * Date: 2021/8/11
 * Desc: 使用FlinkSQL对地区主题统计：以10秒窗口，省份id,省份名，地区编码等分组，统计省份id,省份名，地区编码...订单数，订单金额
 *
 */
public class ProvinceStatsSqlApp {
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        //使用工具类MyKafkaUtil.getKafkaDDL()，获取Kafka配置信息
        ...
        //TODO 3.聚合计算
        /*
        * 窗口开始，结束时间，省份id,省份名，地区编码...订单数，订单金额，统计时间；
        * 以10秒窗口，省份id,省份名，地区编码等分组，
        * */
        //DATE_FORMAT是flink sql内置函数
